...
| 2 | Глобальная ALLOW-политика (исключение) | `allow` | `allowed_by_global_policy` |
| 3 | Пользователь отключил тип+канал | `deny` | `disabled_by_user` |
...
Ключевые трактовки: глобальный запрет (комплаенс) **выше** согласия пользователя; тихие часы
